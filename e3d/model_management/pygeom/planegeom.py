...
class PlaneGeometry(Geometry):
    def __init__(self, width, height, depth, widthSegments=1, heightSegments=1, depthSegments=1):
        ...
        # segment_height = height / gridY
        #
        # vertices = [0.0] * gridX1 * gridY1 #* 3
        # normals = [0.0] * (gridX1 * gridY1 * 3)
        # uvs = [0.0] * (gridX1 * gridY1 * 2)
        #
        # offset = 0
        # offset2 = 0
        #
        ...
        # offset = 0
        #
        # indices = [0]*(len(vertices) / 3) * gridX * gridY * 6
        #
        # for iy in range(gridY):
        #
        #     for ix in range(gridX):
        ...
        #         offset += 6
        #
        # setattr(self, 'index', indices)
        # setattr(self, 'vertices', vertices)
        # setattr(self, 'normal', normals)
        # setattr(self, 'uv', uvs)
